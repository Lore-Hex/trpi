...
function parseArgs(): Args {
	...
	let days = 7;
	let cwd = process.cwd();
	let sessionsBase = join(homedir(), ".tr-confidential-cowork", "agent", "sessions");
...
Options:
  ...
  --sessions-base <path>    Sessions base directory (default: ~/.tr-confidential-cowork/agent/sessions)
