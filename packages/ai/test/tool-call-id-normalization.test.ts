...
function copilotResponsesModel() {
	...
	if (!model) throw new Error("Copilot catalog has no Responses model for the live handoff test");
	return model;
}
 ...
 *
 * 1. Use a current github-copilot Responses model to generate a tool call
