> TRPI can create prompt templates. Ask it to build one for your workflow.
...
TRPI loads prompt templates from:

- Global: `~/.trpi/agent/prompts/*.md`
- Project: `.trpi/prompts/*.md` (only after the project is trusted)
