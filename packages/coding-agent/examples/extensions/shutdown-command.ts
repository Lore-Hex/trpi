 ...
 * Demonstrates how extensions can use ctx.shutdown() to exit TRPI cleanly.
 */
...
export default function (pi: ExtensionAPI) {
	...
	pi.registerTool({
		...
		description: "Complete a task and exit TRPI",
	...
	pi.registerTool({
		...
		description: "Deploy the application and exit TRPI",
		parameters: Type.Object({
