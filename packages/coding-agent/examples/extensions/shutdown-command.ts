 ...
 * Demonstrates how extensions can use ctx.shutdown() to exit TR Confidential Cowork cleanly.
 */
...
export default function (pi: ExtensionAPI) {
	...
	pi.registerCommand("quit", {
		description: "Exit TR Confidential Cowork cleanly",
	...
	pi.registerTool({
		...
		description: "Complete a task and exit TR Confidential Cowork",
	...
	pi.registerTool({
		...
		description: "Deploy the application and exit TR Confidential Cowork",
		parameters: Type.Object({
