...
Content`,
		...
		it("should auto-discover root markdown skills from the app skill dirs", async () => {
...
Content`,
	...
	describe("auto-discovered skill metadata", () => {
		...
		it("should use the project app config dir as baseDir for project skills", async () => {
	...
	describe(".agents/skills auto-discovery", () => {
		...
		it("should dedupe user skill entries when the app skills directory is a symlink to ~/.agents/skills", async () => {
			const previousHome = process.env.HOME;
			process.env.HOME = tempDir;
