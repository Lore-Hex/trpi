...
Attribution:
- Internal: `Fixed foo ([#123](https://github.com/Lore-Hex/trpi/issues/123))`
- External: `Added bar ([#456](https://github.com/Lore-Hex/trpi/pull/456) by [@user](https://github.com/user))`
